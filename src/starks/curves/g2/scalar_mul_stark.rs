...
pub(crate) struct G2ScalarMulInput {
    pub(crate) s: BigUint,
...
impl<F: RichField + Extendable<D>, const D: usize> G2ScalarMulStark<F, D> {
    ...
    fn generate_one_set(&self, input: &G2ScalarMulInput) -> Vec<[F; G2_SCALAR_MUL_VIEW_LEN]> {
    ...
    fn generate_first_row(
        ...
        let round_flags = generate_round_flags::<F>(0, PERIOD);
...
mod tests {
    ...
    fn g2_scalar_mul() {
        ...
        let inputs = (0..num_inputs)
            .map(|timestamp| G2ScalarMulInput {
